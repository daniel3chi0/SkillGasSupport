...
#include "Character_AttributeSet.generated.h"
 ...
 */
UCLASS()
class SKILL_GAS_SUPPORT_API UCharacter_AttributeSet : public UAttributeSet
{
	GENERATED_BODY()


public:
	UCharacter_AttributeSet();
	...
	//为此属性添加方便可调用的宏
	ATTRIBUTE_ACCESSORS(UCharacter_AttributeSet,DownedHealth);
	...
	ATTRIBUTE_ACCESSORS(UCharacter_AttributeSet, MinMoveSpeed);

	//角色基础攻击力
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_Attack, Category = "Vital Attributes")
	FGameplayAttributeData Attack;
	ATTRIBUTE_ACCESSORS(UCharacter_AttributeSet, Attack);
	...
	//为此属性添加方便可调用的宏
	ATTRIBUTE_ACCESSORS(UCharacter_AttributeSet, Physical);
	...
	ATTRIBUTE_ACCESSORS(UCharacter_AttributeSet, MaxPhysical);
	...
	//为此属性添加方便可调用的宏
	ATTRIBUTE_ACCESSORS(UCharacter_AttributeSet, InjuryReduction);
