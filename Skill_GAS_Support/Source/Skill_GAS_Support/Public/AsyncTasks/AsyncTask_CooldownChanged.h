...
public:
	...
	// 监听cooldown ge 的cooldown tag
	// UseServerCooldown 采用服务器的cooldown
	// 如果使用ServerCooldown, TimeRemaining 和 Duration 会返回 -1 代表本地cooldown预测开始.
	...
	// 及时手动销毁AsyncTask的Handle否则会一直保留在内存中。
