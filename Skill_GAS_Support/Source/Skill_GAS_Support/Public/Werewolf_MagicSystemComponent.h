...
#include "Werewolf_MagicSystemComponent.generated.h"
...
class WESTERN_MAP_API UWerewolf_MagicSystemComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UWerewolf_MagicSystemComponent();
	...
	UFUNCTION(BlueprintCallable)
	FGameplayAbilitySpecHandle GetCurrentEquipedMagicAbilitySpecHandle();
